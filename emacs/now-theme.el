...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
    ...
    `(error ((,class (,@blank :foreground ,white :background ,red))))
    ...
    `(holiday ((,class (,@blank :foreground ,white :background ,red))))
    ...
    `(org-agenda-date-weekend ((,class ,blank)))
    ...
    `(org-date-selected ((,class (,@blank :inherit region))))
    ...
    `(org-tag ((,class ,blank)))
    `(org-todo ((,class (,@blank :foreground ,white :background ,red))))
    ...
    `(success ((,class (,@blank :foreground ,white :background ,green))))
    `(trailing-whitespace ((,class (,@blank :inherit error))))
    `(undo-tree-visualizer-active-branch-face ((t ,blank)))
    `(warning ((,class (,@blank :foreground ,white :background ,yellow))))
