...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
    ...
    `(mode-line ((,class (:background "grey20" :foreground "grey60" :box (:line-width 6 :color "grey20" :style nil)))))
    `(mode-line-buffer-id ((,class)))
    `(mode-line-highlight ((,class (:inherit link))))
    `(mode-line-inactive ((,class (:foreground "grey20" :background "grey86" :box (:line-width 6 :color "grey86" :style nil)))))
