...
(let ((custom--inhibit-theme-enable nil) ; Work around broken custom-theme-set-faces/theme-enable/face-spec-recalc
  ...
  (custom-theme-set-faces
    ...
    `(compilation-line-number ((,class (:foreground ,brown)))) ; TODO Use (nil) instead
    ...
    `(diff-function ((,class (:inherit font-lock-function-name-face))))
    ...
    `(error ((,class (:foreground ,off-white :background ,red))))
    ...
    `(warning ((,class (:foreground ,off-white :background ,yellow))))
